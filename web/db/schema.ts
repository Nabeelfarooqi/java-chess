...
export const players = sqliteTable('players', { id: text('id').primaryKey(), name: text('name').notNull(), pinHash: text('pin_hash') }, t => [uniqueIndex('idx_players_pin').on(t.pinHash)]);
